...
function eventPacMan() {
    ...
    window.addEventListener("keyup", (ev) => {
        if (life == 1 && score < p && ['s', 'z', 'q', 'd', 'S', 'Z', 'Q', 'D'].includes(ev.key)) {
            // anime universel
            anime({
                targets: '#PacT',
                rotate: -45,
            ...
            if (['s', 'S'].includes(ev.key) && PCY < 5 && esp[x].style.borderBottomWidth != "2px" && esp[x + 5].style.borderTopWidth != "2px") {
                x += 5;
            ...
            if (['z', 'Z'].includes(ev.key) && PCY > 1 && esp[x].style.borderTopWidth != "2px" && esp[x - 5].style.borderBottomWidth != "2px") {
                x -= 5;
            ...
            if (['d', 'D'].includes(ev.key) && PCX < 5 && esp[x].style.borderRightWidth != "2px" && esp[x + 1].style.borderLeftWidth != "2px") {
                x++;
            ...
            if (['q', 'Q'].includes(ev.key) && PCX > 1 && esp[x].style.borderLeftWidth != "2px" && esp[x - 1].style.borderRightWidth != "2px") {
                x--;
                PCX = PCX - 1;
                PCX2 -= 1;
                PacMan.style.gridArea = `${PCY}/${PCX}/${PCY2}/${PCX2}`;
